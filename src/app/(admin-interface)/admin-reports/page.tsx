...
import { useAdminMedicalRecords } from '@/hooks/admin/useAdminMedicalRecords';
import { AdminMedicalRecord } from '@/lib/api/admin-medical-records-client';
import { 
  Printer, 
  Search, 
  RefreshCcw, 
...
export default function AdminReportsPage() {
  ...
  const filteredRecords = React.useMemo(() => {
    ...
    return medicalRecords.filter(record => {
      return (
        ...
        (record.doctor?.firstName && record.doctor.firstName.toLowerCase().includes(query)) ||
        (record.doctor?.lastName && record.doctor.lastName.toLowerCase().includes(query))
      );
    });
  ...
  const handlePrint = () => {
    ...
    const doctorName = selectedRecord.doctor 
      ...
      <html>
        ...
        <body>
          ...
          <div class="section">
            ...
            <p><span class="label">Department:</span> ${selectedRecord.doctor?.department || 'N/A'}</p>
            <p><span class="label">Specialty:</span> ${selectedRecord.doctor?.specialty || 'N/A'}</p>
          </div>
  ...
  return (
    <div className="p-6">
      {/* Header with stats */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Medical Reports Management</h1>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.overview.recordsThisMonth}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.overview.recordsThisWeek}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.overview.totalPatients}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.overview.totalDoctors}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.overview.recordsWithPrescription}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Department and Doctor Statistics */}
        {stats && !statsLoading && (
              ...
              <div className="space-y-3">
                {stats.topDoctors.map((doctor, index) => (
                  <div key={index} className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium">{doctor.recordCount}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              {showFilters && (
                <div className="space-y-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-xs text-gray-500">Additional filter options will be implemented here</p>
                </div>
              )}
            </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 truncate">
                          {record.doctor ? `Dr. ${record.doctor.firstName} ${record.doctor.lastName}` : 'Unknown Doctor'}
                        </p>
          ...
          {selectedRecord ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  {selectedRecord.patient && (
                    <div className="p-4 bg-blue-50 rounded-lg">
                      ...
                      <div className="space-y-2">
                        ...
                        <p><span className="font-medium">Email:</span> {selectedRecord.patient.email}</p>
                        <p><span className="font-medium">Phone:</span> {selectedRecord.patient.phone}</p>
                        {selectedRecord.patient.dateOfBirth && (
                          <p><span className="font-medium">DOB:</span> {new Date(selectedRecord.patient.dateOfBirth).toLocaleDateString()}</p>
                        )}
                      </div>
                    </div>
                  )}
                  ...
                  {selectedRecord.doctor && (
                    <div className="p-4 bg-green-50 rounded-lg">
                      ...
                      <div className="space-y-2">
                        <p><span className="font-medium">Name:</span> Dr. {selectedRecord.doctor.firstName} {selectedRecord.doctor.lastName}</p>
                        <p><span className="font-medium">Specialty:</span> {selectedRecord.doctor.specialty}</p>
                        <p><span className="font-medium">Department:</span> {selectedRecord.doctor.department}</p>
                      </div>
                    </div>
                  )}
                </div>
            ...
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="text-gray-600 max-w-md">
                ...
                {filteredRecords.length === 0 && " No medical reports are available."}
              </p>
            </div>
          )}
        </div>
